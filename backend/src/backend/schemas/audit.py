...
class RubricCriterion(BaseModel):
    """Critério avaliado pela Rubrica Estrita do Agente Crítico Financeiro."""
    ...
    notes: str = Field(..., description="Comentário técnico e justificativa do Validador Financeiro")
...
class AuditRunDetailResponse(BaseModel):
    ...
    summary: str = Field(..., description="Parecer executivo emitido pelo Agente Crítico Financeiro")
