        ...
        <div className="w-screen max-w-2xl bg-white border-l border-slate-200 shadow-2xl flex flex-col">
                ...
                <div className="p-5 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between gap-4">
                  ...
                  <div className="text-right space-y-1">
                    ...
                    <p className="text-[11px] text-slate-500">
                      Veredito: <strong className="text-slate-900">{data.critic_verdict}</strong>
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                      {data.sql_evidences.map((item, idx) => (
                        ...
                        >
                          <div className="flex items-center justify-between px-3 py-1.5 bg-slate-100/80 border-b border-slate-200">
                          ...
                          <div className="p-3 space-y-2">
                            <p className="text-[11px] text-slate-700">
                              <strong className="text-slate-900 font-medium">Objetivo:</strong> {item.query_description}
                            </p>
                            <pre className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 text-[11px] font-mono text-emerald-400 overflow-x-auto whitespace-pre-wrap">
                    ...
                    <div className="space-y-2">
                      {data.executed_queries.map((item, idx) => {
                        ...
                        return (
                          <div
                            key={idx}
                            className="rounded-lg bg-white border border-slate-200 shadow-sm text-xs overflow-hidden"
                          >
                            <div className="flex items-center justify-between px-3 py-1 bg-slate-100/80 border-b border-slate-200 text-[11px]">
                              <span className="font-mono text-emerald-700 font-semibold">{toolName || `Query #${idx + 1}`}</span>
                              <button
                            ...
                            <pre className="p-2.5 font-mono text-[11px] text-slate-200 bg-slate-900 border border-slate-800 overflow-x-auto whitespace-pre-wrap">
                              {queryStr}
                            </pre>
                          </div>
                        );
          ...
          <div className="p-5 border-t border-slate-200 bg-slate-50/90 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 border border-emerald-600 text-xs font-bold text-white transition shadow-sm disabled:opacity-40"
            >
